...
class ImageMinimizerPlugin {
  ...
  async optimize(compiler, compilation, assets) {
    ...
    const limit = Math.max(1, this.options.concurrency || (typeof os.availableParallelism === "function" ? {
    ...
    if (this.options.loader) {
      ...
      compiler.hooks.afterPlugins.tap({
        ...
        if (Array.isArray(generatorForLoader)) {
          ...
          generatorForLoader = importGenerators.length > 0 ? (/** @type {G extends EXPECTED_ANY[] ? { [P in keyof G]: Generator<G[P]> } : Generator<G>[]} */
